			...
			<div role="main" class="main">
				<div class="container">
					<div class="row pt-xl">
						<div class="col-md-7">
							...
							<p class="lead mb-xl mt-lg">Bize ulaşmak için aşağıda yer alan formu eksiksiz doldurup bize gönderebilirsiniz...</p>
						...
						<div class="col-md-4 col-md-offset-1">
							...
							<ul class="list list-icons list-icons-style-3 mt-xlg mb-xlg">
								<li><i class="fa fa-map-marker"></i> <strong>Adres</strong><?php echo $ayarcek['ayar_adres']; ?><br><?php echo $ayarcek['ayar_ilce']; ?><br><?php echo $ayarcek['ayar_il']; ?></li>
				...
				<div id="googlemaps" class="google-map google-map-footer">					
					<iframe 
					 ...
					 src="https://www.google.com.tr/maps/embed/v1/place?key=<?php //echo $ayarcek['ayar_goooglemap'];?>&q=<?php// echo $ayarcek['ayar_adres'];?>" allowfullscreen>
					</iframe>
				</div>
			</div>
